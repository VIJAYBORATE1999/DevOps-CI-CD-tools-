...
DOWNLOAD_DIR="/home/ncs/Downloads/TOMCAT INSTALLATION/Jenkins/DownloadTomcatFiles"  #  directory where you want to download Tomcat
EXTRACT_DIR="/home/ncs/Downloads/TOMCAT INSTALLATION/ExtractingTomcatFiles"  #  directory where you want to extract Tomcat
